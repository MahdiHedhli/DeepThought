...
(command injection) → **63.3%** (path traversal)
...
[corpus](benchmarks/rediscovery-corpus.md). Deserialization remains in iteration; ReDoS and
the sandbox-tier memory-safety classes remain unbuilt.
